...
- optional `nl2sql_query` when a working Select AI profile exists
...
### 4. Optional NL2SQL Demo

Prompt:

```text
How many open tickets are there by severity?
```
...
This path requires a working Oracle Select AI profile when using `nl2sql_query`.
