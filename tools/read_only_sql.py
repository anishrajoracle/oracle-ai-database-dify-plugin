...
from oracle_ai_database.sql_safety import MAX_READ_ROWS, bounded_int, parse_bind_parameters
...
class ReadOnlySqlTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage, None, None]:
        try:
            ...
            binds = parse_bind_parameters(tool_parameters.get("bind_parameters"))
