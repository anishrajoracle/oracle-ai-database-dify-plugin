...
BEGIN
  EXECUTE IMMEDIATE 'DROP TABLE DEMO_AGENT_ACTION_LOG PURGE';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
CREATE TABLE DEMO_AGENT_ACTION_LOG (
  ACTION_ID NUMBER PRIMARY KEY,
  TICKET_ID NUMBER NOT NULL REFERENCES DEMO_SUPPORT_TICKETS(TICKET_ID),
